# the interpretation of the json format for understanding the nesting degree of whole lists and dictionaries
body = {'subject': [{'day': 'Ср', 'time': [{'time': '', 'week': ''}],
                     'room': [{'room': "369A", 'location': 'Ломо'}], 'lesson': 'Дискра', 'teacher': 'Поляков',
                     'format': 'Дистант'}, {'day': 'Ср', 'time': [{'time': '', 'week': ''}]}]}


# Идея - раскидать инфу в такой словарь и затем строить по нему xml формат(не охото уже делать)
# пока работает только до глубины == body
